...
const eslintDir = beDevRequire.resolve(`eslint/package.json`);
const eslintRequire = createRequire(eslintDir);
...
(async function main() {
    ...
    process.exitCode = await eslintRequire("./lib/cli").execute(
        process.argv,
